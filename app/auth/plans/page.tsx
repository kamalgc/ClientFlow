...
const plans: {
  ...
  },
  {
    id: "premium",
    name: "Premium",
    description: "Built for agencies and teams managing clients at scale.",
    monthly: 99,
    yearly: 79,
    features: [
      "Unlimited clients",
...
export default function PlansPage() {
  ...
  const handlePlanClick = (planId: PlanId) => {
    ...
    if (!url) {
      console.error("No Stripe URL configured for:", key);
      return;
    }
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex items-center gap-1 rounded-lg border border-neutral-200 bg-neutral-100 px-1 py-1 shadow-sm">
            <button
              ...
              className={`flex items-center rounded-lg px-4 py-1.5 text-xs font-medium transition-all ${
